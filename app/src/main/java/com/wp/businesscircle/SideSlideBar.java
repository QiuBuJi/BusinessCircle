...
public class SideSlideBar extends ViewGroup {
    ...
    public SideSlideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SideSlideBar(Context context, AttributeSet attrs, int defStyleAttr) {
